...
const variants: Record<Variant, string> = {
  primary:
    "text-white bg-gradient-to-b from-cyan to-blue shadow-[0_10px_40px_-12px_rgba(77,124,255,0.65)] hover:shadow-[0_14px_50px_-10px_rgba(77,124,255,0.8)] hover:-translate-y-[1px]",
  secondary:
